...
execute_process(
  COMMAND "/usr/bin/git" show-ref "10.8.x"
  WORKING_DIRECTORY "/Users/adam/Documents/Github/pysmme/extern/carma/extern/armadillo-code"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("10.8.x" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/10.8.x")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/adam/Documents/Github/pysmme/extern/carma/extern/armadillo-code'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/adam/Documents/Github/pysmme/extern/carma/extern/armadillo-code'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
